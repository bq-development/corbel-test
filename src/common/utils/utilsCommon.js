...
function createObjectFromDriverConfigEndpoints (endpointStringArray) {
    var jsonDriverUrl = {};

    // Only needed to get local and remote urls configuration
    var configJson = corbelTest.drivers['DEFAULT_USER'].clone().config;
