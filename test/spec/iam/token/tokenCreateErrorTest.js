describe('In IAM module', function() {
    ...
    describe('when creating an invalid token', function() {
        ...
        it.skip('an error [401] is returned if the audience is not present', function(done) {
        ...
        it.skip('an error [401] is returned if the expired field is not present', function(done) {
            var claims = {
                'iss': claimAdmin.clientId,
                'request_domain': requestDomain,
                'aud': aud,
        ...
        it.skip('an error [401] is returned if the issuer field is not present', function(done) {
            var claims = {
                'request_domain': requestDomain,
                'aud': aud,
                'scope': claimAdmin.scopes,
