describe('In IAM module', function() {
    ...
    describe('when creating an invalid token', function() {
        ...
        it('an error [401] is returned it JWT uses invalid signature key', function(done) {
            var claims = {
                'iss': claimAdmin.clientId,
                'request_domain': requestDomain,
                'aud': aud,
        ...
        it('an error [400] is returned use get token withouth oauth params', function(done) {
            var claims = {
                iss: claimAdmin.clientId,
                aud: aud,
                scope: claimAdmin.scopes,
