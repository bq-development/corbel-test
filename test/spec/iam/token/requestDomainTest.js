...
describe('In IAM module', function() {
  ...
  describe('when requests an access token \
    and the client is not authorized in the request_domain parameter', function() {
  ...
  describe('when requests an access token with request_domain parameter\
    and client domain is an allowed domain', function() {
      it('successes returning an access token', function(done) {
        var claims = {
          //client domain _silkroad
          'iss': clientIdSilkroad,
  ...
  describe('when requests an access token with allowed client domain \
    and some not allowed scopes for request_domain parameter', function() {
      it('fails returning error UNAUTHORIZED(401)', function(done) {
        var claims = {
          'iss': clientIdSilkroad,
          'request_domain': requestDomainClient,
