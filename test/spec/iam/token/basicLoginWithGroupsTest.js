describe('In IAM module, create a user belong to a group and login with basic', function() {
    ...
    var domain = {
        ...
        scopes: ['iam:user:me', 'iam:user:create', 'iam:user:delete', 'iam:group:admin', 'iam:user:group:admin', 'iam:user:read', 'resources:music:favorite:admin', 'resources:music:read_catalog', 'resources:test:test_operations'],
    ...
    var client = {
        ...
        scopes: ['iam:user:me', 'iam:user:create', 'iam:user:delete', 'iam:group:admin', 'iam:user:group:admin', 'iam:user:read'],
        defaultScopes: ['iam:user:me']
    };
    ...
    it('successes accessing to group scopes urls', function(done) {
        corbelTest.common.clients
            ...
            .then(function(userWithGroups) {
                ...
                clientGroup.id = id;
                return corbelDriverRoot.iam.client(domain.id, clientGroup.id)
                    .get()
                    .should.be.eventually.fulfilled;
            }).then(function(response) {
