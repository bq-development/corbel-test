describe('In IAM module', function() {
    ...
    describe.only('while testing user groups', function() {
        var corbelDriver;
        var userId;
        var random;
        ...
        it('an error [404] is returned while trying to add a group to an unexistent user', function(done) {
        ...
        it('an error [422] is returned while trying to add a malformed group to an user', function(done) {
        ...
        it('an error is returned while trying to add a group to an user without authorithation', function(done) {
