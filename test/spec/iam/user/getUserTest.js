describe('In IAM module', function() {
    ...
    describe('while testing get user', function() {
        ...
        it('an user is got through admin driver and userId', function(done) {
        ...
        it('an user is got through admin driver', function(done) {
        ...
        it('an user is got through admin driver and a query using equal', function(done) {
            var params = {
                query: [{
                    '$eq': {
                        'firstName': user.firstName + random
        ...
        it('an user is got through admin driver and a query using equal (user does not exists)', function(done) {
            var params = {
                query: [{
                    '$eq': {
        ...
        it('an user is got through admin driver and a query using like', function(done) {
            var params = {
                query: [{
                    '$like': {
