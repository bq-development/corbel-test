describe('In IAM module', function() {
    ...
    describe('while testing get user', function() {
        ...
        it('an error is returned while trying to get an user with unauthorized driver using "me"', function(done) {
        ...
        it('an error is returned while trying to get an user with unauthorized driver using id', function(done) {
        ...
        it('an error is returned while trying to get an unexistent user', function(done) {
