describe('In IAM module', function() {
    ...
    describe('while testing not found errors in devices', function() {
        ...
        'using user(me) when request retrieve a not existing device information', function(done) {
        ...
        it('fails with 404 not found ' +
        'using user() when request retrieve a not existing device information', function(done) {
        ...
        it('fails with 404 not found ' +
        'using user() when request delete an not existing device', function(done) {
            corbelDriver.iam.user()
        ...
        it('fails with 404 not found ' +
        'using user(me) when request delete an not existing device', function(done) {
            corbelDriver.iam.user('me')
            .deleteDevice('notExistingId')
            .then(function() {
                return corbelDriver.iam.user()
