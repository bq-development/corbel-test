describe('In IAM module', function() {
    ...
    describe('when testing group API', function() {
        ...
        it('an error [401] is returned when trying to add scopes in a group without premissions', function(done) {
            var group = getGroup();
            var id;
        ...
        it('an error [401] is returned when trying to remove scopes in a group without premissions', function(done) {
            var group = getGroup();
            var id;
