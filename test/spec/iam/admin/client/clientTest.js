describe('In IAM module', function() {
    ...
    var getDomain = function(timeStamp, desc, sufix) {
        return {
    ...
    var getClient = function(timeStamp, domainId, sufix) {
        return {
    ...
    var contains = function(array, expectedArray) {
    ...
    describe('when performing client CRUD operations', function() {
        ...
        var createClients = function(amount, domain, timeStamp) {
            ...
            for (var count = 1; count <= amount; count++) {
                ...
                var currentClient = getClient(timeStamp, domain, count);
        ...
        it('a client is created', function(done) {
            ...
            var expectedClient = getClient(timeStamp, testDomainId);
            var createdClientId;
        ...
        it('2 clients are created and have differents keys', function(done) {
            var client1 = getClient(undefined, testDomainId, 1);
            var client2 = getClient(undefined, testDomainId, 2);
            var clientKey1;
            var clientId1;
            var clientId2;
        ...
        it('a client is updated', function(done) {
            var expectedClient = getClient(Date.now(), testDomainId);
        ...
        it('a client is removed', function(done) {
            var client = getClient(Date.now(), testDomainId);
            var clientId;
