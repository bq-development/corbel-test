  ...
  describe('for scope management', function () {
    ...
    it('when create a composite scope with simple scope, and update them, logged user have new scopes',
      function (done) {
        ...
        corbelRootDriver.iam.scope().create(compositeScope)
          .should.be.eventually.fulfilled
          .then(function () {
            return corbelRootDriver.iam.scope().create(testScope)
              .should.be.eventually.fulfilled
          })
          .then(function () {
          ...
          .then(function (id) {
            ...
            return corbelRootDriver.iam.client(domain.id).create(client)
              .should.be.eventually.fulfilled
          })
          .then(function (id) {
            client.id = id

            return corbelRootDriver.iam.client(domain.id, client.id).get()
              .should.be.eventually.fulfilled
          })
          ...
          .then(function (response) {
            return corbelDefaultDriver.iam.users().create(userData)
              .should.be.eventually.fulfilled
          })
          .then(function (id) {
            userData.id = id
          ...
          .then(function () {
            return corbelDefaultDriver.iam.user(userData.id).get()
          ...
          .then(function () {
            ...
            return corbelRootDriver.iam.scope().create(compositeScope)
              .should.be.eventually.fulfilled
          })
          .then(function () {
            return corbelDefaultDriver.iam.user('me').disconnect()
              .should.be.eventually.fulfilled
          })
          .then(function () {
            return corbelTest.common.clients
