...
// cambiar título
        it.only('when create a composite scope with simple scope, and update them,' +
            ...
            .then(function(response) {
                ...
                // falla debido al driver. Lanza 401
                return corbelDefaultDriver.iam.user()
                .create(userData)
                .should.be.eventually.fulfilled;
            })
            .then(function(id) {
                ...
                return corbelTest.common.clients.loginUser(corbelDefaultDriver, userData.username, userData.password)
                .should.be.eventually.fulfilled;
            ...
            .then(function() {
                ...
                return corbelTest.common.clients.loginUser
                    (corbelDefaultDriver, userData.username, userData.password)
                .should.be.eventually.fulfilled;
            })
            .then(function() {
                return corbelDefaultDriver.iam.user(userData.id)
