describe('In IAM module, testing username endpoint ', function() {
    ...
    describe('in getting user\'s id by username', function() {
        it('should return user\'s id if the username is in use', function(done) {
            corbelDriver.iam.username().getUserId(username)
        ...
        it('should respond with error 404 if the username is not in use', function(done) {
            corbelDriver.iam.username().getUserId('test' + username)
    ...
    describe('in checking username\'s availability', function () {
        ...
        if (window.chrome) {
            it('should return true if the username is not in use', function(done) {
                corbelDriver.iam.username().availability('test' + username)
                .should.eventually.be.fulfilled
                .then(function(availability) {
