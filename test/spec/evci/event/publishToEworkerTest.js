describe('In EVCI module', function() {
    ...
    it('when send an event to the test eworker can be retrieve it via resources', function(done) {
        var MAX_RETRY = 30;
        var RETRY_PERIOD = 2;
        ...
        corbelDriver.evci.event(eventType).publish(event).
        should.eventually.be.fulfilled.
        then(function() {

            return corbelTest.common.utils.retry(function() {
                return corbelDriver.resources.resource(eventType, event.id).get()
