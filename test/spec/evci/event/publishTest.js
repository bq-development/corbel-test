describe('In EVCI module', function() {
    ...
    it('when send any valid event success with ACCEPTED (202)', function(done) {
    ...
    it('when send an event with a malformed json fails with UNPROCESSABLE ENTITY (422)', function(done) {
