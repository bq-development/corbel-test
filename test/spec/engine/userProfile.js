    ...
    describe('when requesting a user profile', function() {
        ...
        it('[SANITY] server returns requested info if the user exists', function(done) {
            ...
            .then(function(response) {
                expect(response).to.have.deep.property('data.username').is.equal('silkroad.qa.prod@gmail.com');
                expect(response).to.have.deep.property('data.firstName').is.equal('silkroad.qaProd');
                expect(response).to.have.deep.property('data.email').is.equal('silkroad.qa.prod@gmail.com');
