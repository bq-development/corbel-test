describe('In RESOURCES module', function() {
    ...
    describe('In ACL module', function() {
        ...
        describe('error while testing ACL permission validations', function() {
            var corbelDriver;
            ...
            it.only('an error 422 is returned when trying to update an ACL resource with invalid data', function(done) {
                var ACL = {};
                ACL['user:' + adminUser.id] = {
                    permission : 'ADMIN'
                };
