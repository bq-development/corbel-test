describe('In RESOURCES module', function() {
    ...
    describe('In ACL module', function() {
        ...
        describe('while testing ACL permission validations', function() {
            ...
            it('the permissions of a resource can be updated for a user with READ permissions', function(done) {
                var ACL = {};
            ...
            it('the permissions of a resource can be updated for a user with WRITE permissions', function(done) {
                var ACL = {};
                ACL['user:' + adminUser.id] = {
                    permission : 'ADMIN'
                };
            ...
            it('the permissions of a resource can be updated for a user with ADMIN permissions', function(done) {
                var ACL = {};
                ACL['user:' + adminUser.id] = {
                    permission : 'ADMIN'
                };
            ...
            it('the permissions of a resource can be updated for a group with ADMIN permissions', function(done) {
                var ACL = {};
                ACL['user:' + adminUser.id] = {
                    permission : 'ADMIN'
                };
            ...
            it('the permissions of a resource can be updated for a group with READ permissions', function(done) {
                var ACL = {};
                ACL['user:' + adminUser.id] = {
                    permission : 'ADMIN'
                };
            ...
            it('the permissions of a resource can be updated for a group with WRITE permissions', function(done) {
                var ACL = {};
                ACL['user:' + adminUser.id] = {
                    permission : 'ADMIN'
                };
            ...
            it('the permissions of a resource can be updated with properties', function(done) {
                var ACL = {};
                ACL['user:' + adminUser.id] = {
                    permission : 'ADMIN',
                    properties : {
            ...
            it('the permissions of a resource can be updated for all users with ADMIN permissions', function(done) {
                var ACL = {};
                ACL['user:' + adminUser.id] =  {
                    permission : 'ADMIN'
                };
            ...
            it('the permissions of a resource can be updated for all users with WRITE permissions', function(done) {
                var ACL = {};
                ACL['user:' + adminUser.id] =  {
                    permission : 'ADMIN'
                };
            ...
            it('the permissions of a resource can be updated for all users with READ permissions', function(done) {
                var ACL = {};
                ACL['user:' + adminUser.id] =  {
                    permission : 'ADMIN'
                };
            ...
            it('the permissions can be updated for all users with ADMIN permissions without explicit ADMIN userId',
                   function(done) {
                var ACL = {};
                ACL.ALL = {
                    permission : 'ADMIN'
            ...
            it('the update data are ignored if the permissions entity is malformed',
                   function(done) {
                var ACL = {};
                ACL['user:' + adminUser.id] =  {
                    permission : 'ADMIN'
            ...
            it('the update data are ignored if the updated Field is malformed',
                   function(done) {
                var ACL = {};
                ACL['user:' + adminUser.id] =  {
                    permission : 'ADMIN'
