  ...
  describe('In RESMI module, while testing deletion', function () {
    ...
    it('a registry in a relation is deleted', function (done) {
      corbelDriver.resources.relation(COLLECTION_A, idResourceA1, COLLECTION_B)
        ...
        .then(function (response) {
          ...
          return corbelDriver.resources.relation(COLLECTION_A, idResourceA1, COLLECTION_B)
            .delete(idResourceB).should.be.eventually.fulfilled
        })
        .should.notify(done)
    })
    ...
    it('all registries in a relation are deleted', function (done) {
      ...
      corbelTest.common.resources.createdObjectsToQuery(corbelDriver, COLLECTION_B, amount)
        ...
        .then(function (ids) {
          ...
          return corbelTest.common.resources.createRelationFromSingleObjetToMultipleObject(corbelDriver, COLLECTION_A, idResourceA1, COLLECTION_B, idsResourecesInB)
            .should.be.eventually.fulfilled
        })
        .then(function () {
          return corbelDriver.resources.relation(COLLECTION_A, idResourceA1, COLLECTION_B)
    ...
    it('an element in all relations is deleted', function (done) {
      ...
      corbelTest.common.resources.createdObjectsToQuery(corbelDriver, COLLECTION_B, amount)
        ...
        .then(function () {
          return corbelTest.common.resources.createRelationFromSingleObjetToMultipleObject(corbelDriver, COLLECTION_A, idResourceA2, COLLECTION_B, idsResourecesInB)
            .should.be.eventually.fulfilled
        })
        .then(function () {
          return corbelDriver.resources.relation(COLLECTION_A, idResourceA1, COLLECTION_B)
    ...
    it('when delete realtion with wildcard and any destination fail with NOT ALLOWED METHOD (405)', function (done) {
