describe('In RESOURCES module', function() {
    ...
    describe('In RESMI module, while testing relation sorting operation, ', function() {
        ...
        describe('when getting a relation with sort asc order ', function() {
            it('using a numeric field, elements are returned in asc order', function(done) {
                var params = {
                    sort: {
                        intField: 'asc'
                    }
            ...
            it('in a string field, elements are returned in asc order', function(done) {
                var params = {
                    sort: {
                        stringField: 'asc'
                    }
        ...
        describe('when getting a relation with sort desc order ', function() {
            it('using a numeric field, elements are returned in desc order', function(done) {
                var params = {
                    sort: {
                        intField: 'desc'
                    }
            ...
            it('using a string field, elements are returned in desc order', function(done) {
                var params = {
                    sort: {
                        stringField: 'desc'
                    }
            ...
            it('using a numeric field and aplying query parameters', function(done) {
                var params = {
                    sort: {
                        stringField: 'desc'
                    },
