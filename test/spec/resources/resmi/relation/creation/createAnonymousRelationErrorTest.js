describe('In RESOURCES module', function() {
    ...
    describe('In RESMI module ', function() {
        ...
        describe('when testing AnonymusRelation creation', function() {
            ...
            it('400 is returned creating an anonymous relation with unexistent resource id & data', function(done) {
            ...
            it('400 is returned creating an anonymous relation with unexistent resource id & no data', function(done) {
                corbelDriver.resources.relation(COLLECTION_A, 'notExistingId', RELATION_NAME)
                .addAnonymous()
                .should.be.eventually.rejected.then(function(e) {
                    expect(e).to.have.property('status', 400);
