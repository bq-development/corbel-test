describe('In RESOURCES module', function() {
    ...
    describe.only('In RESMI module, testing relation creation ', function() {
        ...
        afterEach(function(done) {
            ...
            .then(function() {
                return corbelDriver.resources.collection(COLLECTION_A, resourceIdA)
                .delete()
                .should.be.eventually.fulfilled;
            })
            .then(function() {
        ...
        describe('when relating certain resources from a collection to a resource from another collection', function() {
            ...
            it('a relation with no extra fields can be created', function(done) {
                ...
                .then(function(response){
                    expect(response).to.have.deep.property('data.id', COLLECTION_B+'/'+resourceIdB1);
                ...
                .then(function(response){
                    expect(response).to.have.deep.property('data.id', COLLECTION_B+'/'+resourceIdB2);
                    idRelationArray.push(response.data.id);
        ...
        describe('when relating all resources from a collection to a resource from another collection', function() {
            ...
            var allResourceFromCollectionB;
            ...
            it('a relation with no extra fields can be created', function(done) {
                ...
                .should.be.eventually.fulfilled
                .then(function(response){
                    allResourceFromCollectionB = response.data;
                ...
                .then(function(response){
                    expect(response.data.size).to.be.equal(allResourceFromCollectionB.size);
                })                
                .should.notify(done);           
            });
