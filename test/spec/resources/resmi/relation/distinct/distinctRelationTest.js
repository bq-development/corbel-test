describe('In RESOURCES module', function() {
    ...
    describe('In RESMI module, while testing relations with distinct', function() {
        ...
        it('retrieve collection using a field distinct value and' +
            'the query language greater than equals',
            function(done) {
                var params = {
                    distinct: 'distinctField2',
                    query: [{
        ...
        it('retrieve the distinct elements in a relation using some fields', function(done) {
            var params = {
        ...
        it('retrieve the distinct elements in a relation using 2 fields', function(done) {
            var params = {
