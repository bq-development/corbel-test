describe('In RESOURCES module', function() {
    ...
    describe('In RESMI module, testing relation search, ', function() {
        ...
        describe('with indexFieldsOnly parameter set to false', function() {
            var corbelDriver;
            ...
            it('using malformed indexFieldsOnly value returns indexFieldsOnly=false behaviour', function(done) {
                var params = {
                    search: 'test' + random,
                    sort: {
                        sortField: 'asc'
                    },
                    indexFieldsOnly: 'asdfghfd'
                };
