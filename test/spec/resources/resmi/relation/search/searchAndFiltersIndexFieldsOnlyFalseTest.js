describe('In RESOURCES module', function() {
    ...
    describe('In RESMI module, testing relation search, ', function() {
        ...
        describe('with indexFieldsOnly set to false and applying search and filters', function() {
            var corbelDriver;
            ...
            it('400 bad request is returned searching and applying like query filter', function(done) {
                var incompleteChain = 'reso';
