...
describe('In RESOURCES module', function () {
  describe('In RESMI module, while testing CRUD operations ', function () {
    ...
    it('if you update an existing resource but do not update the id field, all fields are update less id',
      function (done) {
        var idRandom = 'id' + Date.now()
        var TEST_OBJECT = {
          test: 'test',
    ...
    it('if you create an object with skip not allowed attributes which starts with an underscore fails returning INVALID ENTITY',
      function (done) {
        var resourceId
