...
describe('In RESOURCES module', function() {
    ...
    describe('In RESMI module, while testing CRUD operations ', function() {
        ...
        describe('when a whole collection is updated through collection.update', function() {
            ...
            it.skip('an error is thrown while using the method with a non-existent field condition', function(done){
                var updateObject = {
                    globalUpdate: 'OK'
                };
                ...
                .then(function(e) {
                    ...
                    expect(e).to.have.deep.property('data.error', 'precondition_failed');
                })
                .should.be.eventually.fulfilled.and.notify(done);
            });
