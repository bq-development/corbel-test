describe('In RESOURCES module', function () {
  describe('In RESMI module, testing pagination', function () {
    ...
    it('when get collection with page size greater than maximum number of elements for page, it fails returning BAD REQUEST',
      function (done) {
        var params = {
          pagination: {
    ...
    it('when get collection with page size less than minimum number of elements for page it fails returning BAD REQUEST',
      function (done) {
        var params = {
          pagination: {
    ...
    it('when get collection with invalid page value, it fails returning BAD REQUEST',
      function (done) {
        var params = {
          pagination: {
            page: -1
    ...
    it('when get collection with invalid query and specific number of element in an specific page, it fails returning BAD REQUEST',
      function (done) {
        var params = {
          query: [{
            'error': {
