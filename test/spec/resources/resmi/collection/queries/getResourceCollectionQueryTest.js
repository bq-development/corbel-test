describe('In RESOURCES module', function () {
  describe('In RESMI module, while testing collection queries', function () {
    ...
    describe('when get collection using the equals query language', function () {
      ...
      it('returns elements satisfying the String equality with complex string', function (done) {
        var params = {
          query: [{
            '$eq': {
    ...
    describe('when get collection using the "greater than" or "equal or "greater than" query language', function () {
      ...
      it('successes returning elements satisfying the request intField equal or greater than 700', function (done) {
        var params = {
          query: [{
            '$gte': {
              intField: 700
    ...
    describe('when get collection using the "less than" or "equal or less than" query language', function () {
      it('returns elements satisfying the request intField less than 300', function (done) {
        var params = {
          query: [{
            '$lt': {
              intField: 300
      ...
      it('returns elements satisfying the request intField equal or less than 300', function (done) {
        var params = {
          query: [{
            '$lte': {
              intField: 300
    ...
    describe('when get collection using the "not equal" query language', function () {
      it('returns elements satisfying the request with intField different of 500', function (done) {
        var params = {
          query: [{
            '$ne': {
              intField: 500
    ...
    describe('when get collection using the "like" query language', function () {
      ...
      it('successes returning elements satisfying the request pattern of StringField containing an escaped regexs special character',
        function (done) {
          var id
