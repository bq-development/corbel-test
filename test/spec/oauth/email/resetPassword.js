...
//                        });
//                        expect(subjects).to.include('reset your account password');
//
//                        response.emailList.list.forEach(function (email) {
...
// 'New Password');
//
//                        return corbelTest.common.mail.random.getMail(response.cookies.PHPSESSID,
//                            resetPasswordMail['mail_id']).should.be.eventually.fulfilled;
//                    })
//                    .then(function (response) {
